...
.L3:
	...
	movl	$0, %eax
	call	printf@PLT
	.loc 1 23 1 discriminator 3
	jmp	.L8
.L5:
	.loc 1 8 65 discriminator 4
	movq	-8(%rbp), %rax
	movq	8(%rax), %rax
	movq	%rax, %rsi
	leaq	.LC3(%rip), %rdi
...
.LASF61:
	.string	"/u/r/i/rithik/private/project_SIM/Sim86/src"
.LASF54:
	.string	"sys_errlist"
.LASF41:
